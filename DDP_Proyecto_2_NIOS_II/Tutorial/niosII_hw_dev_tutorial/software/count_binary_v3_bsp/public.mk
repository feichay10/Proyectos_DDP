...
# setting SOPC_SYSID_BASE_ADDRESS is 0x111030
SOPC_SYSID_FLAG += --sidp=0x111030
ELF_PATCH_FLAG  += --sidp 0x111030

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1713185860
SOPC_SYSID_FLAG += --timestamp=1713185860
ELF_PATCH_FLAG  += --timestamp 1713185860
